...
function Play(){  
  ...
  FormatClues();
  let box = document.getElementById('mohmad');
...
function PrepareBoard(){
  ...
  // console.log(wordArr[i])
   allwords = allwords + 1
    jsondata.words[wordArr[i].value] = 0
  }
...
function BoardCharToElement(c){
  ...
  if (c.value !== null){
    ...
    if (ax=="") { ax += c.char[i].wordIndex} else{ax += ","+ c.char[i].wordIndex}
  ...
  for (let i in jsondata.words) {
    jsondata.words[i] = 0
     ...
     $(this).css("backgroundColor", "red");
        ...
        var nameArr = $(this).attr('data-word').split(',');
        for (let ix in nameArr) {
          jsondata.words[wordsActive[nameArr[ix]].string] += 1
...
for (let i in jsondata.words) {
  if (i.length == jsondata.words[i]) {
    $(".line input" ).each(function() {
     if ($(this).attr('id') != undefined) {
     if ($(this).attr('id').toLowerCase() == i.toLowerCase()) {
      $(this).css("text-decoration", "line-through");
      $(this).css("color", "green");
      correctanswers = correctanswers + 1
    }
  ...
  // console.log("- Word " + i + " has been found.")
  }
}
wronganswers = allwords - correctanswers
document.getElementById('goodanswers').value = correctanswers ;
document.getElementById('wronganswers').value = wronganswers ; //ادا جيت بسوي حقت الادخال وتكون بوست عبر الجافا ويعطيني نتيجه اما صح او اما غلط 000000
});
...
$('#btnAnswers').click(function() {
  ...
  $( ".square input" ).each(function() {
    if (!($(this).attr('data-letter') === ($(this).val().toUpperCase()))) {
      ...
      if  ($(this).css("backgroundColor") == "rgb(0, 128, 0)") { }else{$(this).css("backgroundColor", "yellow")}
    }else{
       $(this).css("backgroundColor",'green') 
    }
});
$('#btnHideAnswers').css("display", "block")
$('#btnAnswers').css("display", "none")
$('#btnCheck').css("display", "none")
});
$('#btnHideAnswers').click(function() {
  if (!($(this).attr('data-letter') === (''))) {
  $( ".square input" ).each(function() {
  ...
  $('#btnHideAnswers').css("display", "none")
$('#btnAnswers').css("display", "block")
